...
### Use `bunx tsgo` for Internal Packages

For internal packages, prefer `bunx tsgo` over bundlers. Bundlers can mangle code before it reaches your app's bundler, causing hard-to-debug issues.
